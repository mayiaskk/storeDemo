...
<HEAD>
    ...
    <script type="text/javascript">
        function addCategory() {
            window.location.href = "${pageContext.request.contextPath}/AdminServlet?method=addCategoryUI";
        }
    </script>
</HEAD>
<body>
                ...
                <c:forEach items="${page.records}" var="c" varStatus="status">
                    <tr onmouseover="this.style.backgroundColor = 'white'"
                        ...
                        <td align="center" style="HEIGHT: 22px">
                            <a href="${pageContext.request.contextPath}/AdminServlet?method=editCategoryUI&cid=${c.cid}">
                        ...
                        <td align="center" style="HEIGHT: 22px">
                            <a href="${pageContext.request.contextPath}/AdminServlet?method=delCategory&cid=${c.cid}">
