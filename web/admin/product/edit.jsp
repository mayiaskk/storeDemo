...
<body>
<!--  -->
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/ProductManageServlet?method=editProduct"
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff" colspan="3">
                <input type="file" name="pimage" value="${pageContext.request.contextPath}/${product.pimage}"/>
            </td>
        </tr>
        <tr>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
