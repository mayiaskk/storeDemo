...
<div class="container">
    <div class="row">
        ...
        <div style="margin:0 auto;width:950px;">
            ...
            <div class="col-md-6">
                ...
                <div style="margin:10px 0 10px 0;">亿家价: <strong
                        style="color:#ef0101;">￥${product.shop_price}元</strong>&nbsp;&nbsp;&nbsp;&nbsp;参考价：
                    <del>￥${product.market_price}元</del>
                </div>

                <div style="margin:10px 0 10px 0;">促销: <a target="_blank" title="限时抢购 (2018-12-30 ~ 2019-02-01)"
                    ...
                    <form id="cartForm" action="${pageContext.request.contextPath}/CartServlet" method="post">
                        ...
                        <div style="margin:20px 0 10px 0;;text-align: center;">
                            ...
                            <a href="javascript:void(0);">
                                ...
                                <input name="method" type="hidden" value="addToCart"/>
                            </a> &nbsp;收藏商品
                        </div>
                    </form>
                </div>
        ...
        <div style="width:950px;margin:0 auto;">
            ...
            <div>
                <div class="container">${product.pdesc}</div>
            </div>
